...
<h2 align="center"> Full-Stack Developer | GenAI & Agentic AI Engineer</h1>
...
## 📄 Resume
  ...
  👉 **[Click here to view my Resume](https://drive.google.com/file/d/1cSLDEvjMHDq2SpQ2EmSBUkRu90Ihxd6z/view)**
...
[Live](https://buildzero.buildworks.online/) | [Source Code](https://github.com/arjunsingpardeshi/v0-clone)
...
[Live](https://leetlab.buildworks.online/) | [Source Code](https://github.com/arjunsingpardeshi/leet-code)
...
- Code Execution: Self-hosted Dockerized Judge0 for development + Judge0 API for production.
...
- Integrated Gemini-powered Query Refiner → improved AI prompt quality.  
- Created final thumbnails using Nano Banana API with refined prompts.
